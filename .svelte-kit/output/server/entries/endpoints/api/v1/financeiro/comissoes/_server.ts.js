...
import { f as fetchSalesReportRows, g as getVendaCommission, a as getVendaVendedorNome, b as getVendaClienteNome } from "../../../../../../chunks/relatorios.js";
async function GET(event) {
  try {
    ...
    const pagoPorVenda = /* @__PURE__ */ new Map();
    if (vendaIds.length > 0) {
      const { data: pagamentos } = await client.from("vendas_pagamentos").select("venda_id, valor_total").in("venda_id", vendaIds);
