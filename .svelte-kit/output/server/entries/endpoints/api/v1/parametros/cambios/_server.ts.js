...
async function GET(event) {
  try {
    ...
    let query = client.from("parametros_cambios").select("id, moeda, data, valor, created_at, owner_user_id, owner_user:owner_user_id(nome_completo)").order("data", { ascending: false }).order("created_at", { ascending: false });
