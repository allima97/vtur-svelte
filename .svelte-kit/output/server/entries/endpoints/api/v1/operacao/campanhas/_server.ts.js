...
async function GET(event) {
  try {
    ...
    let query = client.from("campanhas").select("id, company_id, titulo, imagem_url, imagem_path, link_url, link_instagram, link_facebook, data_campanha, validade_ate, regras, status, created_at, arquivada_em").order("data_campanha", { ascending: false }).limit(200);
