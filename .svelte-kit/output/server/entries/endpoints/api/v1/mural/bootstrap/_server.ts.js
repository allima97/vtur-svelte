import { r as requireMuralScope, a as readCache, f as fetchUsuariosEmpresa, b as fetchRecados, w as writeCache } from "../../../../../../chunks/_shared.js";
async function GET(event) {
  try {
    ...
    if (scope.isMaster) {
      const { data: vinculos, error } = await client.from("master_empresas").select("company_id, status, companies(id, nome_fantasia)").eq("master_id", user.id);
