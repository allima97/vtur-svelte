...
type RouteParams = {  };
type RouteId = '/(app)/perfil/escala';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/perfil/escala/+page.server.js').load>>>>>>;
