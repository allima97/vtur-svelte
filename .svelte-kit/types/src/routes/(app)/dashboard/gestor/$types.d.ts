...
type RouteParams = {  };
type RouteId = '/(app)/dashboard/gestor';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/dashboard/gestor/+page.server.js').load>>>>>>;
