...
type RouteParams = {  };
type RouteId = '/(app)/dashboard/master';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/dashboard/master/+page.server.js').load>>>>>>;
