...
type RouteParams = {  };
type RouteId = '/(app)/dashboard/vendedor';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/dashboard/vendedor/+page.server.js').load>>>>>>;
