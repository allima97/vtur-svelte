...
type RouteParams = {  };
type RouteId = '/(app)/parametros/escalas';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/parametros/escalas/+page.server.js').load>>>>>>;
