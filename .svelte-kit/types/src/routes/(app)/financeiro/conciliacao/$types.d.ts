...
type RouteParams = {  };
type RouteId = '/(app)/financeiro/conciliacao';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/financeiro/conciliacao/+page.server.js').load>>>>>>;
