...
type RouteParams = {  };
type RouteId = '/(app)/financeiro/ajustes-vendas';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/financeiro/ajustes-vendas/+page.server.js').load>>>>>>;
