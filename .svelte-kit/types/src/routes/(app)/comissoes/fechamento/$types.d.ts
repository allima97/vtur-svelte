...
type RouteParams = {  };
type RouteId = '/(app)/comissoes/fechamento';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(app)/comissoes/fechamento/+page.server.js').load>>>>>>;
