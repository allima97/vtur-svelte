-- 2026-02-24: allow ensure_default_perms_vendedor trigger to bypass RLS
...
begin
  -- Temporarily disable RLS because this trigger runs while the signup request is still under
  -- the anonymous/service role that cannot see the new modulo_acesso rows yet.
