-- Garante competencia por recibo para vendas importadas e para o fluxo RPC.
-- O ranking filtra por vendas_recibos.data_venda; recibos sem essa data ficam invisiveis.
