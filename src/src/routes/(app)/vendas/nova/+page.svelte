          ...
          {#each recibos as recibo, index}
            <div class="rounded-xl border border-slate-200 p-4">
              ...
              <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div>
                  <FieldInput id={`venda-nova-recibo-rav-${index}`} label="RAV" bind:value={recibo.valor_rav} class_name="w-full" />
                </div>
                <div>
      ...
      <FormPanel title="Resumo e observações" description="Verifique totais e adicione notas" class_name="border-green-200">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-4">
          <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
            ...
            <p class="mt-2 text-lg font-semibold text-slate-900">{formatCurrency(totalRecibos)}</p>
          </div>
          <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
            <p class="text-xs uppercase tracking-wide text-slate-500">Taxas</p>
            <p class="mt-2 text-lg font-semibold text-slate-900">{formatCurrency(totalTaxas)}</p>
          </div>
          <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
            <p class="text-xs uppercase tracking-wide text-slate-500">Pagamentos</p>
            <p class="mt-2 text-lg font-semibold text-slate-900">{formatCurrency(totalPagamentos)}</p>
          </div>
          <div class="rounded-xl border border-slate-200 bg-slate-50 p-4">
