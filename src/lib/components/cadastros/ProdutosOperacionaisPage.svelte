...
<div class="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
  <div class="vtur-card border-l-4 border-l-financeiro-500 p-4">
    <div class="flex items-center gap-3">
      <div class="rounded-lg bg-financeiro-50 p-2">
        <Package size={20} class="text-financeiro-600" />
      </div>
      <div>
  ...
  <div class="vtur-card border-l-4 border-l-sky-500 p-4">
    <div class="flex items-center gap-3">
      <div class="rounded-lg bg-sky-50 p-2">
        <Globe2 size={20} class="text-sky-600" />
      </div>
      <div>
        <p class="text-sm text-slate-500">Globais</p>
        <p class="text-2xl font-bold text-slate-900">{stats.globais}</p>
      </div>
    </div>
  </div>
  <div class="vtur-card border-l-4 border-l-purple-500 p-4">
    <div class="flex items-center gap-3">
      <div class="rounded-lg bg-purple-50 p-2">
        <Hotel size={20} class="text-purple-600" />
      </div>
      <div>
        <p class="text-sm text-slate-500">Hospedagem</p>
        <p class="text-2xl font-bold text-slate-900">{stats.hospedagem}</p>
      </div>
    </div>
  </div>
</div>
