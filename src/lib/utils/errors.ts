 ...
 * Prioriza conteúdos explícitos do erro (message/error/details/reason/data.message/data.error/data.details/data.reason/data.cause/response.data.message/response.data.error/response.data.details/response.data.reason) e usa fallback normalizado quando nada útil é encontrado.
 */
