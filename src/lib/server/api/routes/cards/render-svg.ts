// Migrado para Hono de src/routes/api/v1/cards/render.svg/+server.ts — corpo IDÊNTICO ao original
...
export async function handleCardsRenderSvgGet(event: import('@sveltejs/kit').RequestEvent) {
  try {
