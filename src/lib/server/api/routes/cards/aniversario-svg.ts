// Migrado para Hono de src/routes/api/v1/cards/aniversario.svg/+server.ts — corpo IDÊNTICO ao original
...
export const handleCardsAniversarioSvgGet = async ({ request, getClientAddress }: RequestEvent) => {
