// Migrado para Hono de src/routes/api/v1/cards/render/+server.ts — corpo IDÊNTICO ao original
...
export async function handleCardsRenderGet(event: import('@sveltejs/kit').RequestEvent) {
  try {
