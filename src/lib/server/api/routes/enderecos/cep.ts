// Migrado para Hono de src/routes/api/v1/enderecos/cep/+server.ts — corpo IDÊNTICO ao original
...
export const handleEnderecosCepGet = async ({ url, fetch, getClientAddress }: RequestEvent) => {
