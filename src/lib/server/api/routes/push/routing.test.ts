/**
 * Roteamento de /api/v1/push/* no Hono (gerado por gen_routing_test.py).
 *
...
vi.mock('./subscribe', () => ({ handlePushSubscribePost: spy('handlePushSubscribePost') }));
vi.mock('./unsubscribe', () => ({ handlePushUnsubscribePost: spy('handlePushUnsubscribePost') }));

import { apiApp } from '../../app';
import * as catchAll from '../../../../../routes/api/v1/[...path]/+server';

const CASES: Array<[string, string, string, Record<string, string>]> = [
  ['POST', '/api/v1/push/subscribe', 'handlePushSubscribePost', {}],
  ['POST', '/api/v1/push/unsubscribe', 'handlePushUnsubscribePost', {}],
];

const SEM_HANDLER: Array<[string, string]> = [
  ['PUT', '/api/v1/push/subscribe'],
  ['PUT', '/api/v1/push/unsubscribe'],
];
