// Migrado para Hono de src/routes/api/v1/push/subscribe/+server.ts — corpo IDÊNTICO ao original
...
export const handlePushSubscribePost = async (event: RequestEvent) => {
  try {
