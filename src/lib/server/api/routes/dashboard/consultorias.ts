// Migrado para Hono de src/routes/api/v1/dashboard/consultorias/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardConsultoriasGet(event: RequestEvent) {
  try {
