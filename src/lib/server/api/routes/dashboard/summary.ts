// Migrado para Hono de src/routes/api/v1/dashboard/summary/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardSummaryGet(event: RequestEvent) {
  try {
