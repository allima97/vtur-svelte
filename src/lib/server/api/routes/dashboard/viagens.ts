// Migrado para Hono de src/routes/api/v1/dashboard/viagens/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardViagensGet(event: RequestEvent) {
  try {
