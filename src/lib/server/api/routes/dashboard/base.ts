// Migrado para Hono de src/routes/api/v1/dashboard/base/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardBaseGet(event: RequestEvent) {
  try {
