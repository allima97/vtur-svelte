// Migrado para Hono de src/routes/api/v1/dashboard/comparativo-empresas/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardComparativoEmpresasGet(event: RequestEvent) {
  try {
