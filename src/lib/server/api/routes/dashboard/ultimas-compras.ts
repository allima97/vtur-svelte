// Migrado para Hono de src/routes/api/v1/dashboard/ultimas-compras/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardUltimasComprasGet(event: RequestEvent) {
  try {
