// Migrado para Hono de src/routes/api/v1/dashboard/follow-ups/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardFollowUpsGet(event: RequestEvent) {
  try {
