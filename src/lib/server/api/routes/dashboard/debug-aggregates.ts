// Migrado para Hono de src/routes/api/v1/dashboard/debug-aggregates/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardDebugAggregatesGet(event: RequestEvent) {
  try {
