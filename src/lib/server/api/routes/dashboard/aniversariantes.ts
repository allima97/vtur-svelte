// Migrado para Hono de src/routes/api/v1/dashboard/aniversariantes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardAniversariantesGet(event: RequestEvent) {
  try {
