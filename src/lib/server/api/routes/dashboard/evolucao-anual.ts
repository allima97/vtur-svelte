// Migrado para Hono de src/routes/api/v1/dashboard/evolucao-anual/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDashboardEvolucaoAnualGet(event: RequestEvent) {
  try {
