/**
 * Roteamento de /api/v1/cidades/* no Hono (gerado por gen_routing_test.py).
 *
...
vi.mock('./root', () => ({ handleCidadesGet: spy('handleCidadesGet'), handleCidadesPost: spy('handleCidadesPost'), handleCidadesDelete: spy('handleCidadesDelete') }));
vi.mock('./id', () => ({ handleCidadesIdGet: spy('handleCidadesIdGet'), handleCidadesIdPatch: spy('handleCidadesIdPatch'), handleCidadesIdDelete: spy('handleCidadesIdDelete') }));

import { apiApp } from '../../app';
import * as catchAll from '../../../../../routes/api/v1/[...path]/+server';

const CASES: Array<[string, string, string, Record<string, string>]> = [
  ['GET', '/api/v1/cidades', 'handleCidadesGet', {}],
  ['POST', '/api/v1/cidades', 'handleCidadesPost', {}],
  ['DELETE', '/api/v1/cidades', 'handleCidadesDelete', {}],
  ['GET', '/api/v1/cidades/id-123', 'handleCidadesIdGet', {"id": "id-123"}],
  ['PATCH', '/api/v1/cidades/id-123', 'handleCidadesIdPatch', {"id": "id-123"}],
  ['DELETE', '/api/v1/cidades/id-123', 'handleCidadesIdDelete', {"id": "id-123"}],
];

const SEM_HANDLER: Array<[string, string]> = [
  ['PUT', '/api/v1/cidades'],
  ['PUT', '/api/v1/cidades/id-123'],
];
