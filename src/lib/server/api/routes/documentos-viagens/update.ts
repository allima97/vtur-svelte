// Migrado para Hono de src/routes/api/v1/documentos-viagens/update/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDocumentosViagensUpdatePost(event: RequestEvent) {
  try {
