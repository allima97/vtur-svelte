// Migrado para Hono de src/routes/api/v1/documentos-viagens/save-template/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDocumentosViagensSaveTemplatePost(event: RequestEvent) {
  try {
