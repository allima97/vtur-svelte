// Migrado para Hono de src/routes/api/v1/documentos-viagens/delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDocumentosViagensDeletePost(event: RequestEvent) {
  try {
