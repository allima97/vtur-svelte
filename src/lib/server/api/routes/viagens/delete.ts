// Migrado para Hono de src/routes/api/v1/viagens/delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensDeletePost(event: RequestEvent) {
  try {
