// Migrado para Hono de src/routes/api/v1/viagens/dossie-batch/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensDossieBatchPost(event: RequestEvent) {
  try {
