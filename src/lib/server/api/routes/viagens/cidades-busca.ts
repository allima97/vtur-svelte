// Migrado para Hono de src/routes/api/v1/viagens/cidades-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensCidadesBuscaGet(event: RequestEvent) {
  try {
