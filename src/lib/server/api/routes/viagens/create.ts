// Migrado para Hono de src/routes/api/v1/viagens/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensCreatePost(event: RequestEvent) {
  try {
