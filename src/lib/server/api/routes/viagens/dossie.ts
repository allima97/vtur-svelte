// Migrado para Hono de src/routes/api/v1/viagens/dossie/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensDossieGet(event: RequestEvent) {
  try {
