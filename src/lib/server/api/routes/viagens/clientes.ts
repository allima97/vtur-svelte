// Migrado para Hono de src/routes/api/v1/viagens/clientes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensClientesGet(event: RequestEvent) {
  try {
