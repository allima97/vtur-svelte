// Migrado para Hono de src/routes/api/v1/viagens/cliente/[id]/+server.ts — corpo IDÊNTICO ao original
...
export async function handleViagensClienteIdGet(event: RequestEvent) {
  try {
