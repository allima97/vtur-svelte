// Migrado para Hono de src/routes/api/v1/produtos/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleProdutosCreatePost(event: RequestEvent) {
  try {
