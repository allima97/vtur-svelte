// Migrado para Hono de src/routes/api/v1/agenda/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAgendaCreatePost(event: RequestEvent) {
  try {
