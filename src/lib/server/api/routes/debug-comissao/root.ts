// Migrado para Hono de src/routes/api/v1/debug-comissao/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDebugComissaoGet(event: RequestEvent) {
  try {
