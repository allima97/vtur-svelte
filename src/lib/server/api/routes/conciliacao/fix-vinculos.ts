// Migrado para Hono de src/routes/api/v1/conciliacao/fix-vinculos/+server.ts — corpo IDÊNTICO ao original
...
export async function handleConciliacaoFixVinculosPost(event: RequestEvent) {
  try {
