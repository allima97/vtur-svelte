// Migrado para Hono de src/routes/api/v1/mural/company/+server.ts — corpo IDÊNTICO ao original
...
export async function handleMuralCompanyGet(event: RequestEvent) {
  try {
