// Migrado para Hono de src/routes/api/v1/mural/bootstrap/+server.ts — corpo IDÊNTICO ao original
...
export async function handleMuralBootstrapGet(event: RequestEvent) {
  try {
