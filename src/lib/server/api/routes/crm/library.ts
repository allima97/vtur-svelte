// Migrado para Hono de src/routes/api/v1/crm/library/+server.ts — corpo IDÊNTICO ao original
...
export async function handleCrmLibraryGet(event: import('@sveltejs/kit').RequestEvent) {
  try {
