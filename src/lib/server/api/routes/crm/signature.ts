// Migrado para Hono de src/routes/api/v1/crm/signature/+server.ts — corpo IDÊNTICO ao original
...
export async function handleCrmSignaturePost(event: RequestEvent) {
  try {
