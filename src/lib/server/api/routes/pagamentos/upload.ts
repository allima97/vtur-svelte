// Migrado para Hono de src/routes/api/v1/pagamentos/upload/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePagamentosUploadPost(event: RequestEvent) {
  try {
