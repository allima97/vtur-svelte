// Migrado para Hono de src/routes/api/v1/vouchers/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVouchersCreatePost(event: RequestEvent) {
  try {
