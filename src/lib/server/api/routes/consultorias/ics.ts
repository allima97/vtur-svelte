// Migrado para Hono de src/routes/api/v1/consultorias/ics/+server.ts — corpo IDÊNTICO ao original
...
export const handleConsultoriasIcsGet = async (event: RequestEvent) => {
  try {
