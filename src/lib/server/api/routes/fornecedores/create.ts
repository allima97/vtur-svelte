// Migrado para Hono de src/routes/api/v1/fornecedores/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleFornecedoresCreatePost(event: RequestEvent) {
  try {
