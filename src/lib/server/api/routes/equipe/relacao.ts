// Migrado para Hono de src/routes/api/v1/equipe/relacao/+server.ts — corpo IDÊNTICO ao original
...
export const handleEquipeRelacaoPost = async (event: RequestEvent) => {
  try {
