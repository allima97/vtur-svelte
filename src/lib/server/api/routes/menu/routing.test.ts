/**
 * Roteamento de /api/v1/menu/* no Hono (gerado por gen_routing_test.py).
 *
...
vi.mock('./prefs', () => ({ handleMenuPrefsGet: spy('handleMenuPrefsGet'), handleMenuPrefsPost: spy('handleMenuPrefsPost') }));

import { apiApp } from '../../app';
import * as catchAll from '../../../../../routes/api/v1/[...path]/+server';

const CASES: Array<[string, string, string, Record<string, string>]> = [
  ['GET', '/api/v1/menu/prefs', 'handleMenuPrefsGet', {}],
  ['POST', '/api/v1/menu/prefs', 'handleMenuPrefsPost', {}],
];

const SEM_HANDLER: Array<[string, string]> = [
  ['PUT', '/api/v1/menu/prefs'],
];
