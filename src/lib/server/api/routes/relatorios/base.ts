// Migrado para Hono de src/routes/api/v1/relatorios/base/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRelatoriosBaseGet(event: RequestEvent) {
  try {
