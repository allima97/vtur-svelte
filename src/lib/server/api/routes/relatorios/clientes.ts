// Migrado para Hono de src/routes/api/v1/relatorios/clientes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRelatoriosClientesGet(event: RequestEvent) {
  try {
