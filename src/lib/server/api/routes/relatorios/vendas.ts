// Migrado para Hono de src/routes/api/v1/relatorios/vendas/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRelatoriosVendasGet(event: RequestEvent) {
  try {
