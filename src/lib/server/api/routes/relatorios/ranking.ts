// Migrado para Hono de src/routes/api/v1/relatorios/ranking/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRelatoriosRankingGet(event: RequestEvent) {
  try {
