// Migrado para Hono de src/routes/api/v1/admin/email/test/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminEmailTestPost(event: RequestEvent) {
  try {
