// Migrado para Hono de src/routes/api/v1/admin/auth/mfa-status/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminAuthMfaStatusPost(event: RequestEvent) {
  try {
