// Migrado para Hono de src/routes/api/v1/admin/auth/set-password/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminAuthSetPasswordPost(event: RequestEvent) {
  try {
