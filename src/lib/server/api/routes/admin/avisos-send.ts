// Migrado para Hono de src/routes/api/v1/admin/avisos/send/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminAvisosSendPost(event: RequestEvent) {
  try {
