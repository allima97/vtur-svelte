// Migrado para Hono de src/routes/api/v1/admin/tipos-usuario/[id]/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminTiposUsuarioIdGet(event: RequestEvent) {
  try {
