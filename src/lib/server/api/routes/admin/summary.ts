// Migrado para Hono de src/routes/api/v1/admin/summary/+server.ts — corpo IDÊNTICO ao original
...
export async function handleAdminSummaryGet(event: RequestEvent) {
  try {
