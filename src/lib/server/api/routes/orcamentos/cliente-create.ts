// Migrado para Hono de src/routes/api/v1/orcamentos/cliente-create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosClienteCreatePost(event: RequestEvent) {
  try {
