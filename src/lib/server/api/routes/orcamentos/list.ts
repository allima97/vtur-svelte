// Migrado para Hono de src/routes/api/v1/orcamentos/list/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosListGet(event: RequestEvent) {
  try {
