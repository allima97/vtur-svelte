// Migrado para Hono de src/routes/api/v1/orcamentos/[id]/resumo-venda/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosIdResumoVendaGet(event: RequestEvent) {
  try {
