// Migrado para Hono de src/routes/api/v1/orcamentos/clientes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosClientesGet(event: RequestEvent) {
  try {
