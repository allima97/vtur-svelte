// Migrado para Hono de src/routes/api/v1/orcamentos/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosCreatePost(event: RequestEvent) {
  try {
