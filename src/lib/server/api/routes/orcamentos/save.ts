// Migrado para Hono de src/routes/api/v1/orcamentos/save/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosSavePost(event: RequestEvent) {
  try {
