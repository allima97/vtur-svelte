// Migrado para Hono de src/routes/api/v1/orcamentos/tipos/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosTiposGet(event: RequestEvent) {
  try {
