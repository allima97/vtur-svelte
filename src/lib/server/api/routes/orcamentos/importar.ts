// Migrado para Hono de src/routes/api/v1/orcamentos/importar/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosImportarPost(event: RequestEvent) {
  try {
