// Migrado para Hono de src/routes/api/v1/orcamentos/delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosDeletePost(event: RequestEvent) {
  try {
