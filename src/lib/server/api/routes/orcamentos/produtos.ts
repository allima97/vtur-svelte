// Migrado para Hono de src/routes/api/v1/orcamentos/produtos/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosProdutosGet(event: RequestEvent) {
  try {
