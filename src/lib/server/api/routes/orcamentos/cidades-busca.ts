// Migrado para Hono de src/routes/api/v1/orcamentos/cidades-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handleOrcamentosCidadesBuscaGet(event: RequestEvent) {
  try {
