// Migrado para Hono de src/routes/api/v1/tarefas/usuarios/+server.ts — corpo IDÊNTICO ao original
...
export async function handleTarefasUsuariosGet(event: RequestEvent) {
  try {
