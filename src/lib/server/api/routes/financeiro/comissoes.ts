// Migrado para Hono de src/routes/api/v1/financeiro/comissoes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleFinanceiroComissoesGet(event: RequestEvent) {
  try {
