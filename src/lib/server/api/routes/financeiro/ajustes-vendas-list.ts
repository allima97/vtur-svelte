// Migrado para Hono de src/routes/api/v1/financeiro/ajustes-vendas/list/+server.ts — corpo IDÊNTICO ao original
...
export async function handleFinanceiroAjustesVendasListGet(event: RequestEvent) {
  try {
