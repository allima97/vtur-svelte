// Migrado para Hono de src/routes/api/v1/clientes/historico/+server.ts — corpo IDÊNTICO ao original
...
export async function handleClientesHistoricoGet(event: RequestEvent) {
  try {
