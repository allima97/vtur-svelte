// Migrado para Hono de src/routes/api/v1/clientes/resolve-import/+server.ts — corpo IDÊNTICO ao original
...
export async function handleClientesResolveImportPost(event: RequestEvent) {
  try {
