// Migrado para Hono de src/routes/api/v1/clientes/avisos/history/+server.ts — corpo IDÊNTICO ao original
...
export async function handleClientesAvisosHistoryGet(event: RequestEvent) {
  try {
