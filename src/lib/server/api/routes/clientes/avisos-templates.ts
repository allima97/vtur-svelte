// Migrado para Hono de src/routes/api/v1/clientes/avisos/templates/+server.ts — corpo IDÊNTICO ao original
...
export async function handleClientesAvisosTemplatesGet(event: RequestEvent) {
  try {
