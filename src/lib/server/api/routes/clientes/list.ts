// Migrado para Hono de src/routes/api/v1/clientes/list/+server.ts — corpo IDÊNTICO ao original
...
export async function handleClientesListGet(event: RequestEvent) {
  try {
