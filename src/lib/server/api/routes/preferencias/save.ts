// Migrado para Hono de src/routes/api/v1/preferencias/save/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasSavePost(event: RequestEvent) {
  try {
