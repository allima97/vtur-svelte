// Migrado para Hono de src/routes/api/v1/preferencias/list/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasListGet(event: RequestEvent) {
  try {
