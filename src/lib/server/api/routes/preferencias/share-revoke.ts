// Migrado para Hono de src/routes/api/v1/preferencias/share-revoke/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasShareRevokePost(event: RequestEvent) {
  try {
