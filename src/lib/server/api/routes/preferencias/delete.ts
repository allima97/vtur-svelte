// Migrado para Hono de src/routes/api/v1/preferencias/delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasDeletePost(event: RequestEvent) {
  try {
