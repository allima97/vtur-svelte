// Migrado para Hono de src/routes/api/v1/preferencias/share/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasSharePost(event: RequestEvent) {
  try {
