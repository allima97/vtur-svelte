// Migrado para Hono de src/routes/api/v1/preferencias/cidades-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasCidadesBuscaGet(event: RequestEvent) {
  try {
