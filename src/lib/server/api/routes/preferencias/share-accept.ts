// Migrado para Hono de src/routes/api/v1/preferencias/share-accept/+server.ts — corpo IDÊNTICO ao original
...
export async function handlePreferenciasShareAcceptPost(event: RequestEvent) {
  try {
