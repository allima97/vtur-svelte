// Migrado para Hono de src/routes/api/v1/debug/vendas-recibos-diff/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDebugVendasRecibosDiffGet(event: RequestEvent) {
  try {
