// Migrado para Hono de src/routes/api/v1/debug/permissions/+server.ts — corpo IDÊNTICO ao original
...
export async function handleDebugPermissionsGet(event: RequestEvent) {
  try {
