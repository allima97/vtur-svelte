// Migrado para Hono de src/routes/api/v1/users/aniversariantes/+server.ts — corpo IDÊNTICO ao original
...
export async function handleUsersAniversariantesGet(event: RequestEvent) {
  try {
