/**
 * Roteamento de /api/v1/paises/* no Hono (gerado por gen_routing_test.py).
 *
...
vi.mock('./root', () => ({ handlePaisesGet: spy('handlePaisesGet'), handlePaisesPost: spy('handlePaisesPost'), handlePaisesDelete: spy('handlePaisesDelete') }));

import { apiApp } from '../../app';
import * as catchAll from '../../../../../routes/api/v1/[...path]/+server';

const CASES: Array<[string, string, string, Record<string, string>]> = [
  ['GET', '/api/v1/paises', 'handlePaisesGet', {}],
  ['POST', '/api/v1/paises', 'handlePaisesPost', {}],
  ['DELETE', '/api/v1/paises', 'handlePaisesDelete', {}],
];
