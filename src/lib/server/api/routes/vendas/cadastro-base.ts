// Migrado para Hono de src/routes/api/v1/vendas/cadastro-base/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasCadastroBaseGet(event: RequestEvent) {
  try {
