// Migrado para Hono de src/routes/api/v1/vendas/[id]/ranking-recibos/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasIdRankingRecibosGet(event: RequestEvent) {
  try {
