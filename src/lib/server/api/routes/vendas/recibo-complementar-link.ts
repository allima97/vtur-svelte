// Migrado para Hono de src/routes/api/v1/vendas/recibo-complementar-link/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboComplementarLinkPost(event: RequestEvent) {
  try {
