// Migrado para Hono de src/routes/api/v1/vendas/recibo-edit/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboEditPatch(event: RequestEvent) {
  try {
