// Migrado para Hono de src/routes/api/v1/vendas/recibo-complementar-remove/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboComplementarRemovePost(event: RequestEvent) {
  try {
