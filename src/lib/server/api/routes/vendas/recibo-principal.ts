// Migrado para Hono de src/routes/api/v1/vendas/recibo-principal/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboPrincipalPost(event: RequestEvent) {
  try {
