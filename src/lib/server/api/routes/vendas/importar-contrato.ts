// Migrado para Hono de src/routes/api/v1/vendas/importar-contrato/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasImportarContratoPost(event: RequestEvent) {
  try {
