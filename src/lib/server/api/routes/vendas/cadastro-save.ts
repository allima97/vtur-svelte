// Migrado para Hono de src/routes/api/v1/vendas/cadastro-save/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasCadastroSavePost(event: RequestEvent) {
  try {
