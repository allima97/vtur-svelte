// Migrado para Hono de src/routes/api/v1/vendas/recibo-notas/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboNotasGet(event: RequestEvent) {
  try {
