// Migrado para Hono de src/routes/api/v1/vendas/merge-candidates/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasMergeCandidatesGet(event: RequestEvent) {
  try {
