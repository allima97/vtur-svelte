// Migrado para Hono de src/routes/api/v1/vendas/cidades-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasCidadesBuscaGet(event: RequestEvent) {
  try {
