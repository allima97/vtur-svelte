// Migrado para Hono de src/routes/api/v1/vendas/merge/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasMergePost(event: RequestEvent) {
  try {
