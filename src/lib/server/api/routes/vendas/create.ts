// Migrado para Hono de src/routes/api/v1/vendas/create/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasCreatePost(event: RequestEvent) {
  try {
