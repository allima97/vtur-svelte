// Migrado para Hono de src/routes/api/v1/vendas/recibo-delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasReciboDeletePost(event: RequestEvent) {
  try {
