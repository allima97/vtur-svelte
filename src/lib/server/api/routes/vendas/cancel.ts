// Migrado para Hono de src/routes/api/v1/vendas/cancel/+server.ts — corpo IDÊNTICO ao original
...
export async function handleVendasCancelPost(event: RequestEvent) {
  try {
