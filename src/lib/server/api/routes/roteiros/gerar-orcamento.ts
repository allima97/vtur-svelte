// Migrado para Hono de src/routes/api/v1/roteiros/gerar-orcamento/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosGerarOrcamentoPost(event: RequestEvent) {
  try {
