// Migrado para Hono de src/routes/api/v1/roteiros/delete/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosDeleteDelete(event: RequestEvent) {
  try {
