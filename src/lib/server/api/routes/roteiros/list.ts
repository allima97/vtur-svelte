// Migrado para Hono de src/routes/api/v1/roteiros/list/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosListGet(event: RequestEvent) {
  try {
