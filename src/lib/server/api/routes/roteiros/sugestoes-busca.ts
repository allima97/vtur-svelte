// Migrado para Hono de src/routes/api/v1/roteiros/sugestoes-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosSugestoesBuscaGet(event: RequestEvent) {
  try {
