// Migrado para Hono de src/routes/api/v1/roteiros/save/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosSavePost(event: RequestEvent) {
  try {
