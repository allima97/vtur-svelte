// Migrado para Hono de src/routes/api/v1/roteiros/sugestoes-salvar/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosSugestoesSalvarPost(event: RequestEvent) {
  try {
