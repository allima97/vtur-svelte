// Migrado para Hono de src/routes/api/v1/roteiros/sugestoes-remover/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosSugestoesRemoverPost(event: RequestEvent) {
  try {
