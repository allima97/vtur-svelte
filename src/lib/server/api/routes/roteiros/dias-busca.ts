// Migrado para Hono de src/routes/api/v1/roteiros/dias-busca/+server.ts — corpo IDÊNTICO ao original
...
export async function handleRoteirosDiasBuscaGet(event: RequestEvent) {
  try {
