<script lang="ts">
  ...
  import { RefreshCw, Building2, CheckCircle, CreditCard, Network } from '$lib/icons';
...
<svelte:head>
  <title>Empresas Master | VTUR</title>
</svelte:head>

<PageHeader
  title="Empresas Master"
  subtitle="Empresas acessiveis ao master com billing e portfolio vinculado."
  breadcrumbs={[
...
<div class="space-y-6">
  ...
  <DataTable
    ...
    onRowClick={(row: Empresa) => goto(`/master/empresas/${row.id}`)}
  />
</div>
